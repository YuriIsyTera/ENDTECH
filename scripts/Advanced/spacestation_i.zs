...
MachineModifier.setMaxThreads("spacestation_i",0);
MachineModifier.addCoreThread("spacestation_i",FactoryRecipeThread.createCoreThread("地对空上行链路维护单元"));
MachineModifier.addCoreThread("spacestation_i",FactoryRecipeThread.createCoreThread("链接器维护"));
MachineModifier.addCoreThread("spacestation_i",FactoryRecipeThread.createCoreThread("巨构装配体"));

RecipeBuilder.newBuilder("maintainance_i","spacestation_i",100,1)
 .addFactoryStartHandler(function(event as FactoryRecipeStartEvent){
    val ctrl = event.controller;
    val data = ctrl.customData;
    val map = data.asMap();
    map["is_connect"]=1;
    map["spacestation_level"]=1;
 ...
 .build();
//上行链路失效
RecipeBuilder.newBuilder("failed_i","spacestation_i",1,4)
 ...
 .setThreadName("地对空上行链路维护单元")
 .build();
RecipeBuilder.newBuilder("communication_connection_i","spacestation_i",100,1)
  .addPreCheckHandler(function(event as RecipeCheckEvent){
    val ctrl = event.controller;
